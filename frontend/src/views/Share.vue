<template>
  <div>
    <header-bar showMenu showLogo>
      ...
      <button v-if="isSingleFile()" class="action copy-clipboard" :aria-label="t('buttons.copyDownloadLinkToClipboard')"
        :data-title="t('buttons.copyDownloadLinkToClipboard')" @click="copyToClipboard(linkSelected())">
      ...
      <div v-if="error.status === 401">
        <div class="card floating" id="password" style="z-index: 9999999">
          ...
          <div class="card-content">
            <input v-focus class="input input--block" type="password" :placeholder="t('login.password')"
              v-model="password" @keyup.enter="fetchData" />
          </div>
    ...
    <div v-else-if="req !== null">
      <div class="share">
        <div class="share__box share__box__info" style="
        ...
        req.isDir
          ...
          <div v-if="!req.isDir" class="share__box__element share__box__center share__box__icon">
        ...
        " style="height: 12em; padding-top: 1em; margin: 0">
              ...
              <audio id="myaudio" ref="audio" :src="raw" controls :autoplay="tag"></audio>
            </div>
            <video v-else-if="!fileStore.multiple &&
        fileStore.selectedCount === 1 &&
        req.items[fileStore.selected[0]].type === 'video'
        " style="height: 12em; padding: 0; margin: 0" :src="raw" controls>
              Sorry, your browser doesn't support embedded videos, but don't
              worry, you can <a :href="raw">download it</a>
              and watch it with your favorite video player!
            </video>
            <i v-else-if="!fileStore.multiple &&
        fileStore.selectedCount === 1 &&
        ...
        <div id="shareList" v-if="req.isDir && req.items.length > 0" class="share__box share__box__items">
          ...
          <div id="listing" class="list file-icons">
            ...
            <div :class="{ active: fileStore.multiple }" id="multiple-selection">
              ...
              <div @click="() => (fileStore.multiple = false)" tabindex="0" role="button"
                :data-title="t('buttons.clear')" :aria-label="t('buttons.clear')" class="action">
